...
<div class="container1">
    <p>CATEGORY MANAGERMENT</p>
<div>
<a href="?page=add_category"><button class="button" style="vertical-align:middle"><span>ADD </span></button></a>
...
<table style="width:100%">
    ...
    <tbody>
			...
			<tr>
              ...
              <a href="?page=update_category&&id=<?php echo $row["Cat_ID"]; ?>" style="color: green; text-decoration: none;">
              &#9998;</a></td>
              <td style='text-align:center'>
              <a href="category.php?function=del&&id=<?php echo $row["Cat_ID"]; ?>" style="color: red; text-decoration: none;" 
